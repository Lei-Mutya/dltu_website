            ...
            <div className="row justify-content-center py-3">
                ...
                <h3 className="text-light py-2">What is a Student Information System?</h3>
                    ...
                    <div className="row justify-content-center py-5">
                        ...
                        <Link className="text-decoration-none fw-bold text-dark" to='/studentlog'><button><img src="https://www.pngitem.com/pimgs/m/573-5730618_green-person-icon-transparent-png-green-person-icon.png" width="200" height="200"/>STUDENT'S LOG-IN</button></Link>
                        </div>
                        <div className="col col-md-2 ms-5">
                        <Link className="text-decoration-none fw-bold text-dark" to='/adminlog'><button><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCSqQpa0CpYQbVzqYnhvD9xQUmid_qcoaJHpmbcJYnHvlDWEKvhkcQmgcNhfh_0Dv4sQI&usqp=CAU" width="200" height="200"/>ADMIN LOG-IN</button></Link>
                        </div>
                    </div>
